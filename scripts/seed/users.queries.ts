...
const getUserByIdIR: any = {"name":"GetUserById","params":[{"name":"userId","transform":{"type":"scalar"},"codeRefs":{"used":[{"a":62,"b":67,"line":7,"col":8}]}}],"usedParamSet":{"userId":true},"statement":{"body":"SELECT\n  *\nFROM\n  users\nWHERE\n  id = :userId","loc":{"a":24,"b":67,"line":2,"col":0}}};
...
const insertTestUserIR: any = {"name":"InsertTestUser","params":[{"name":"user","codeRefs":{"defined":{"a":106,"b":109,"line":12,"col":8},"used":[{"a":252,"b":255,"line":16,"col":5}]},"transform":{"type":"pick_tuple","keys":["firstName","lastName","email","password","username"]}}],"usedParamSet":{"user":true},"statement":{"body":"INSERT INTO users (first_name, last_name, email, \"password\", username)\n  VALUES\n    :user\n  RETURNING\n    *","loc":{"a":167,"b":273,"line":14,"col":0}}};
 ...
 * ```
 */
export const insertTestUser = new PreparedQuery<IInsertTestUserParams,IInsertTestUserResult>(insertTestUserIR);
