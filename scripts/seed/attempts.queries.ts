...
const getAttemptsByUserIdIR: any = {
  name: "GetAttemptsByUserId",
  params: [
    {
      name: "userId",
      transform: { type: "scalar" },
      codeRefs: { used: [{ a: 78, b: 83, line: 7, col: 13 }] },
    },
  ],
  usedParamSet: { userId: true },
  statement: {
    body: "SELECT\n  *\nFROM\n  attempts\nWHERE\n  user_id = :userId",
    loc: { a: 32, b: 83, line: 2, col: 0 },
  },
}
 ...
 * ```
 */
export const getAttemptsByUserId = new PreparedQuery<
  IGetAttemptsByUserIdParams,
  IGetAttemptsByUserIdResult
>(getAttemptsByUserIdIR)
...
const insertAttemptForUserIdIR: any = {
  name: "InsertAttemptForUserId",
  params: [
    {
      name: "attempt",
      codeRefs: {
        defined: { a: 129, b: 135, line: 12, col: 8 },
        used: [{ a: 240, b: 246, line: 16, col: 5 }],
      },
      transform: {
        type: "pick_tuple",
        keys: ["grade", "send", "date", "userId"],
      },
    },
  ],
  usedParamSet: { attempt: true },
  statement: {
    body:
 ...
 * ```
 */
export const insertAttemptForUserId = new PreparedQuery<
  IInsertAttemptForUserIdParams,
  IInsertAttemptForUserIdResult
>(insertAttemptForUserIdIR)
